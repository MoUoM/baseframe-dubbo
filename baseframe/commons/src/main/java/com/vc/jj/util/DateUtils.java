...
public class DateUtils {
     ...
     * 上个月第一天
     */
    public static String getYesterdayMonthFirstDay() throws ParseException{
         String firstDay;
        //获取前月的第一天
    ...
    /**
     上个月最后一天
     */
    public static String getYesterdayMonthLastDay() throws ParseException{
        String lastDay;
        SimpleDateFormat format = new SimpleDateFormat("yyyy-MM-dd");
        String  firstDay = getYesterdayMonthFirstDay();
        //获取前月的最后一天
