...
import com.vc.jj.util.StringUtil;
...
public class DateUtil extends DateUtils {
    ...
    public static String DateMode_12 = "yyyyMM";
    ...
    public static SimpleDateFormat date_format_month = new SimpleDateFormat(DateMode_12);
